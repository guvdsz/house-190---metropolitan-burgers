	...
	return (
		<Section className="bg-brand-gray relative overflow-hidden">
			...
			<div
				...
				style={{
					backgroundImage:
						"url('https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/New_York_City_Skyline_Silhouette.svg/2560px-New_York_City_Skyline_Silhouette.svg.png')",
			...
			<div className="flex flex-col items-center text-center mb-12 md:mb-24 relative z-10">
				...
				<p className="mt-6 text-gray-400 max-w-lg text-sm md:text-base px-6">
					É muito{" "}
					<strong className="text-white">FÁCIL PEDIR</strong> seu
					burger aqui{" "}
					<strong className="text-white">NA HOUSE 190</strong>
				</p>
			</div>
							...
							<div className="bg-white/5 border border-white/10 p-5 md:p-8 rounded-sm backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-brand-yellow/50 hover:shadow-[0_0_30px_rgba(0,0,0,0.5)] group">
								<div className="flex items-center gap-3 mb-2 md:mb-4 md:justify-end">
									<MousePointerClick
										...
										size={20}
									/>
									<h3 className="text-xl md:text-2xl font-display uppercase text-white group-hover:text-brand-yellow transition-colors">
										Link na Bio
									</h3>
									<MousePointerClick
										className="text-brand-yellow hidden md:block"
										size={24}
									/>
								</div>
								<p className="text-gray-400 text-sm md:text-base mb-4 md:mb-6 leading-relaxed">
									Acesse nosso cardápio digital
									completo, promoções do dia e clube
									fidelidade.
								</p>
								<a
								...
								>
									<Button
										variant="outline"
										className="text-xs md:text-sm py-3 px-6 h-auto w-full md:w-auto flex items-center justify-center gap-2 group hover:bg-brand-yellow hover:text-black hover:border-brand-yellow"
									>
										Acessar Beacons{" "}
										<ExternalLink
											size={16}
						...
						<div className="w-full md:w-1/2 md:text-left pl-20 md:pl-0 md:pl-16 relative">
							...
							<div className="bg-white/5 border border-white/10 p-5 md:p-8 rounded-sm backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-brand-yellow/50 hover:shadow-[0_0_30px_rgba(0,0,0,0.5)] group">
								...
								<p className="text-gray-400 text-sm mb-4 md:hidden">
									Atendimento personalizado em todas
									as unidades.
								</p>
								<ul className="text-gray-400 text-sm md:text-base space-y-2 font-sans mb-5 border-l-2 border-brand-yellow/20 pl-4 hidden md:block">
									<li>
										(73) 99947-0290 - Teixeira de
										Freitas
									</li>
									<li>
										(73) 98817-1354 - Eunápolis
									</li>
									<li>
										(73) 99832-3630 - Porto Seguro
									</li>
									<li>
										(73) 99105-4373 - Itamaraju
									</li>
								</ul>
								<Button
									variant="ghost"
									className="text-xs md:text-sm py-3 px-0 text-brand-yellow hover:text-white w-full md:w-auto flex items-center justify-center md:justify-start gap-2 border border-brand-yellow/20 md:border-none rounded md:rounded-none"
									onClick={() =>
										document
											.getElementById(
												"locations",
					...
					<div className="relative flex flex-col md:flex-row items-start md:items-center">
						...
						<div className="w-full md:w-1/2 md:text-right pl-20 md:pl-0 md:pr-16 relative">
							...
							<div className="bg-white/5 border border-white/10 p-5 md:p-8 rounded-sm backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-brand-yellow/50 hover:shadow-[0_0_30px_rgba(0,0,0,0.5)] group">
								...
								<p className="text-gray-400 text-sm md:text-base mb-4 md:mb-6 leading-relaxed">
									A comodidade da entrega rápida
									direto no conforto da sua casa.
								</p>
